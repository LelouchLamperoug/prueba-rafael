...
const Modal = ({ data, isOpen, onClose, loading }) => {
        ...
        <div data-testid="modal-overlay" className="modal-overlay">
            <div className="modal">
                ...
                <div className="modal-upper-content">
                    ...
                    <h3 data-testid="hover-title">
                        {hoveredItem ? hoveredItem.name : ""}
                    </h3>
                    <span data-testid="hover-range">
                        {hoveredItem ? hoveredItem.timeRange : ""}
                    </span>
                    <span data-testid="hover-description">
                        ...
                        <div className="channels-name">
                            ...
                            {data.map((channel, index) => (
                                <div key={index} className="channel-row">
                                    <img className="image" alt="tv-logo" src={channel.image} />
                        ...
                        <div className="schedule">
                            ...
                            <div>
                                {dataTransformed.map((channel, index) => (
                                    <div key={index} className="programs-row">
                                        {channel.events.map((program, index) => (
                                            <div
                                                className="program"
                                                style={{ minWidth: program.minWidth }}
                                                key={index}
                                                onMouseEnter={() => handleMouseEnter(program)}
                                                onMouseLeave={handleMouseLeave}
                                            >
                                                <span title={program.name} className="timerange">
                                                    {program.name}
                                                </span>
